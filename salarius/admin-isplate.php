	...
	<div class="glavni">
		<div class="levi">
			...
			<div class="srednji">
				...
				<?php
				$Upit = "SELECT * FROM isplate WHERE verifikacija = '0' LIMIT 1";
				...
				<div class='infon'>
					<div>ID isplate: <span>".$Red['id']."</span></div>
					<div>Isplatiti: <span>".$Red['nagrada']."</span></div>
					<div>Cena: <span>".$Red['cena']." </span></div>
					...
					$_SESSION["idisplate"]=$Red['id'];
					
					echo "<form style='width: 100%;' action='php/odbijanjeisplate.php'>
					<div class='ta'>
					<p>Napomena:</p>
					<textarea name='napomena'></textarea></div>
					<div class='btns'>
					<button type='submit' class='btn odbij'>Odbij isplatu</button></form>
					<a href='php/odobravanjeisplate.php' class='btn bz'>Prihvati isplatu</a>
					</div>
				</div>";
				}
				?>
